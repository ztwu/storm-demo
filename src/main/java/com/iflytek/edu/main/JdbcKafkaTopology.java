...
import com.iflytek.edu.Bolt.KafkaBolt;
...
public class JdbcKafkaTopology {
    ...
    public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException, InterruptedException, AlreadyAliveException, AuthorizationException {
        ...
        builder.setBolt("word-counter", new KafkaBolt(),3).directGrouping("kafka-reader");

        Config conf = new Config();

        String name = JdbcKafkaTopology.class.getSimpleName();
